...
<html lang="en">
  <head>
    ...
    <title>Sistem Pencatatan Prestasi & Pelanggaran Siswa</title>
    <script language="JavaScript">
      var txt=":: Sistem Pencatatan Prestasi & Pelanggaran Siswa ";
      ...
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="main.php?module=home" class="site_title">
                <div class="logo_pic"><img src="images/fav.png" alt="..." class="img-lgkrn logo_img"></div>
        ...
        <footer>
          <div class="pull-right">
            Sistem Pencatatan Prestasi & Pelanggaran Siswa &copy;2023
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
