                  ...
                  <div class="col-md-12">
                    ...
                    <?php
                      ...
                      while($total=mysqli_fetch_array($hitungTotal)){
                        ...
                        elseif ($totalPoin>=75 && $totalPoin<=99) {
                        ...
                        elseif ($totalPoin>=100 && $totalPoin<=124) {
                    ...
                    <div class="col-md-9">
                      <div class="row tile_count">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
                          <span class="count_top" ><i class="fa fa-envelope-square"></i> Data SP 1</span>
                          <div class="count">
                        ...
                        <a href="main.php?module=laporan_pelanggaran">
                            <span class="count_bottom"><button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target=".cetaksp3">Periksa Data Pelanggaran</button></span>
                        </a>
                        <!-- Penutup SP 1 -->
                        ...
                        <!-- SP 2 -->
                        <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
                          <span class="count_top"><i class="fa fa-envelope-square"></i> Data SP 2</span>
                          <div class="count">
                        ...
                        <!-- SP 3 -->
                        <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
                          <span class="count_top"><i class="fa fa-envelope-square"></i> Data Drop Out</span>
                          <div class="count">
